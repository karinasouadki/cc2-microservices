...
Payment system
- API version: 1.0.0
  - Build date: 2022-06-01T20:39:34.656749+02:00[Europe/Paris]
...
------------ | ------------- | ------------- | -------------
*PaymentControllerApi* | [**payment**](docs/PaymentControllerApi.md#payment) | **POST** /api/v1/payments | Payment
